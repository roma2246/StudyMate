...
const s = {
  ...
  aCard: { background: 'rgba(15, 23, 42, 0.45)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '16px', overflow: 'hidden' },
  ...
  tag: { fontSize: '0.75rem', color: 'rgba(255,255,255,0.45)', background: 'rgba(15, 23, 42, 0.45)', padding: '0.25rem 0.625rem', borderRadius: '100px', fontWeight: '600' },
  ...
  answerBox: { background: 'rgba(15, 23, 42, 0.45)', borderRadius: '8px', padding: '0.75rem', marginTop: '0.5rem' },
  ...
  modal: { background: '#0f1e3a', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '20px', padding: '2rem', width: '100%', maxWidth: '560px', maxHeight: '85vh', overflowY: 'auto' },
  ...
  textarea: { width: '100%', padding: '0.75rem 1rem', background: 'rgba(15, 23, 42, 0.45)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '10px', fontSize: '0.9375rem', color: '#fff', fontFamily: 'inherit', outline: 'none', boxSizing: 'border-box', resize: 'vertical' },
  ...
  gradeInfo: { background: 'rgba(15, 23, 42, 0.45)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '12px', padding: '1rem', marginBottom: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' },
  gradeInfoRow: { fontSize: '0.875rem', color: 'rgba(255,255,255,0.7)' },
  answerPreview: { fontSize: '0.875rem', color: 'rgba(255,255,255,0.55)', lineHeight: 1.5, maxHeight: '120px', overflowY: 'auto', background: 'rgba(15, 23, 42, 0.45)', borderRadius: '8px', padding: '0.625rem', marginTop: '0.5rem' },
};
