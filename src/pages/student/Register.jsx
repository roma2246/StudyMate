...
const StudentRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await register(formData.name, formData.username, 'student', formData.password);
      ...
      <div style={styles.mainContainer}>
        <div style={styles.leftSection}>
          <div style={styles.logoSection}>
            ...
            <p style={styles.tagline}>Регистрация студента</p>
          </div>
          ...
          <div style={styles.features}>
            ...
            <div style={styles.feature}>
              <span style={styles.featureIcon}>📊</span>
              <div>
                <h3 style={styles.featureTitle}>Отслеживание</h3>
                <p style={styles.featureText}>Детальная статистика успеваемости</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={styles.rightSection}>
          <div style={styles.formContainer}>
            <div style={styles.formHeader}>
              <h2 style={styles.formTitle}>Регистрация студента</h2>
              <p style={styles.formSubtitle}>Создайте аккаунт студента</p>
            </div>
